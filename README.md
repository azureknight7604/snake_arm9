...
> [!NOTE]
> Make sure that you download the correct savefile for your game's region. Also, you'll notices that at the end of the filename, that there are melon_PC and melon_android. 'melon_PC' is for the desktop version of melonDS emulator (Windows, Mac, Linux, etc.) and 'melon_android' is for the android port of melonDS emualtor.
